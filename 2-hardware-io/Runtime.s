...
! =====================  GetCh()  =====================
!
! Project 2 - GetCh Implementation in assembly
!
GetCh:
	!-- 1. Preserve all registers to store contents
	push r2 
	push r3 
	push r4 
	push r5 

	! r2 - Use r2 to hold Actual Serial Data Value
	! r3 - Use r3 to hold SERIAL_STAT Address
	! r4 - Use r4 to hold SERIAL_DATA Address
	! r5 - Use r5 to hold Actual Serial Stat Value
...
wait1:
	load [r3], r5 			!-- load value of r3 into r5
	
	btst 0x00000001,r5 		!-- bittest r5 with value 0x00000001
	
	be wait1 			!-- if r5 is 0 keep looping

	load [r4], r2 			!-- When r5 is 1., load the actual data into r2

	storeb r2, [r15 + 20]		!-- Current stack has r5, r4, r3, r2, return address(Called by echoprime.k), [Serial DATA gets stored here]
					!-- Each block takes 4 bytes so [r15 + 20] points to the block after the return address

	!-- 3. Pop the registers to retrieve back the context
	pop r5
	pop r4
	pop r3
	pop r2
...
SERIAL_STAT = 0x00ffff00 		!-- Reference address value for Serial stat
SERIAL_DATA = 0x00ffff04		!-- Reference address value for Serial data
